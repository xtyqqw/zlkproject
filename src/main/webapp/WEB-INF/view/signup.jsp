...
<div class="wrap" id="wrap">
    <div class="logGet">
        ...
        <form action="<%=request.getContextPath()%>/users/signup" method="post" onsubmit="return check()">
            ...
            <br><br>
            <input name="ck" onclick="doJudge()" id="ck" type="checkbox" value=""
                   style="margin-left: 130px;margin-right: 10px">已阅读并同意
            <a>《智量酷安全协议》</a>
            <br><br>
            <div class="logC">
                <a href="" target="_self">
                    <button id="btn1" disabled="disabled" type="submit">注册</button>
                </a>
            </div>
        </form>
    </div>
