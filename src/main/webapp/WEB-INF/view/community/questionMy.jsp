        ...
        flow.load({
            ...
            ,done: function(page, next){ //加载下一页
                ...
                setTimeout(function(){
                    ...
                    $.ajax({
                        url:"/question/questionMy?page="+page+"&limit="+limit+"&userId="+userId,
                        type: 'post',
                        dataType: "json",
                        success: function (result) {
                            layui.each(result.articleList, function (i, article) {
                                ...
                                html += '<div class="kuang">'+
                                    ...
                                    '</div>'+
                                    '<div class="userImg">'+question.user.userImg+'</div>'+
                                    ...
                                    '<div class="browseCount"><a href="#">'+article.browseCount+'查看详情'+'</a></div>'+
                                    ...
                                    '<div class="commentCount"><a href="#">'+article.commentCount+'为他解答'+'</a></div>'+
                                    '</div>';
                                lis.push(html);
                            });
