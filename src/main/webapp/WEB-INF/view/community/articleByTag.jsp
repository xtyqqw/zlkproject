            ...
            flow.load({
                ...
                ,done: function(page, next){ //加载下一页
                    ...
                    setTimeout(function(){
                        ...
                        var limit = "5";
                        $.ajax({
                            url:"/getArticleByTag?page="+page+"&limit="+limit,
                            type: 'post',
                            dataType: "json",
                            success: function (result) {
                                layui.each(result.articleList, function (i, article) {
                                    ...
                                    html += '<div class="all" >' +
                                        ...
                                        '<div class="createArticleType" id="createArticleType">';
                                            if (article.createArticleType == 0) {
                                                html += '<div class="ui orange basic label">原创</div>';
                                            }else if(article.createArticleType == 1) {
                                                html += '<div class="ui orange basic label">转载</div>';
                                            }else if (article.createArticleType == 2) {
                                                html += '<div class="ui orange basic label">翻译</div>';
                                            }
                                        '</div>';
