            ...
            <form action="<%=request.getContextPath() %>/question/update" method="post" class="ui form">
                ...
                <div class="required field">
                    <div id="md-content" style="z-index: 1 !important;">
                        <textarea class="editormd-markdown-textarea" name="questionContent" style="display: none">${questions.questionContent}</textarea>
                    </div>
                </div>
                        ...
                        <div>
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="createTime" value="${questions.createTime}" id="createTime" autocomplete="off" class="layui-input"
                    ...
                    <div class="required field">
                        <div>
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="updateTime" value="${questions.updateTime}" id="updateTime" autocomplete="off" class="layui-input"
                                           style="margin-top: -35px;margin-left: -29px;width: 39.3vw;">
                                </div>
                            </div>
                        </div>
