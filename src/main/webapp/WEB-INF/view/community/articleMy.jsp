        ...
        <c:forEach items="${articleList}" var="article" begin="0" end="4">
            <div class="all">
                ...
                <div>
                    ...
                    <div class="createTime" id="createTime"><span id="time">${article.createTime.getTime()}</span></div>
                </div>
            ...
            flow.load({
                ...
                ,done: function(page, next){ //加载下一页
                    ...
                    setTimeout(function(){
                        var lis = [];
                        var limit =5;
                        var userId="adfd95a4b3634b58b0cf3b8c67b18a27";
                        var data={"page":page,"limit":limit,"userId":userId};
                        console.log(data);
                        $.ajax({
                            type :"POST",
                            url:"/article/findByUserId",
                            dataType:"json",
                            data:data,
