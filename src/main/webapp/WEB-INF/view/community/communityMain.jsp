...
<div class="all-body">
    ...
    <div class="all-body-center">
            ...
            <div style="height: 0px; margin-bottom: -10px;">
                <div class="show">
                    <c:forEach items="${tagList}" var="tag">
                        <ul>
                            <li>
                                <a class="tags" href="<%=request.getContextPath() %>/community/tags?tagId=${tag.tagId}"
                                   type="button" target="pageTags">${tag.tagName}</a>
                            </li>
                        </ul>
                    </c:forEach>
                </div>
        ...
        <div class="body-left">
            ...
            <iframe class="iframe" name="pageTags" frameborder="1"
                    src="<%= request.getContextPath()%>/articles/toArticleAll"></iframe>
        </div>
        <div class="add">
