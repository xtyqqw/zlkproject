...
public class StuNoteController {
    ...
    @ResponseBody
    public Map upAdd(@RequestParam("snId") Integer snId, @RequestParam("userId") String userId){
        HashMap map = new HashMap<>();
    ...
    @ResponseBody
    public Map downAdd(@RequestParam("snId") Integer snId, @RequestParam("userId") String userId){
        HashMap map = new HashMap<>();
    ...
    @ResponseBody
    public Map upDelete(@RequestParam("snId") Integer snId, @RequestParam("userId") String userId){
        HashMap map = new HashMap<>();
    ...
    @ResponseBody
    public Map downDelete(@RequestParam("snId") Integer snId, @RequestParam("userId") String userId){
        HashMap map = new HashMap<>();
    ...
    @ResponseBody
    public Map upAddDownDelete(@RequestParam("snId") Integer snId, @RequestParam("userId") String userId){
        HashMap map = new HashMap<>();
    ...
    @ResponseBody
    public Map downAddUpDelete(@RequestParam("snId") Integer snId, @RequestParam("userId") String userId){
        HashMap map = new HashMap<>();
